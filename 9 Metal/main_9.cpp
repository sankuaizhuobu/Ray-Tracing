...
int main(int argc, char** args) {
	...
	//world.add(std::make_shared<Sphere>(Point3(0, 0, -1), 0.5));  // 添加一个小表面
	//world.add(std::make_shared<Sphere>(Point3(0, -100.5, -1), 100));  // 添加一个大表面
	...
	*/
	...
	std::ofstream fout("output/Image10.ppm");  // ppm文件  里面是像素的RGB
